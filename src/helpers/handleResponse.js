const serverErrorRespMsg = {
  ERROR_OCCURRED:
    "We have an unexpected error. Please, " +
...
const authMessages = {
  ...
  REGISTER_SUCCESS:
    "User registered successfully. Please, check email to active your account.",
  ...
  INACTIVE_USER:
    "User is not active. Please, check your e-mail and active your account.",
  SIGN_TOKEN_ERROR: "Unable to sign token.",
  INCORRECT_PASSWORD: "Incorrect password.",
  UNEXISTENT_USER: "User not found.",
  FORGOT_PASSWORD_SUCCESS:
    "If your email exists, you will receive a password recovery link in few seconds.",
  ...
  RESET_PASSWORD_EXPIRED:
    "Invalid or expired Token, try to reset password again.",
...
const userMessages = {
  ...
  USER_SELECT_ROLE_EXISTS:
    "User has a role defined, please contact administrator to change.",
};
