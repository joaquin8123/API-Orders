...
//     expect(decrypt(res.password), 'Password should have been encrypted').to.be.equal(
//       params.password,
//     );
//   });
...
//       },
//     });
//     await expectCodeThrowsAsync(() => clientsEntity({ params }), 'usernameError');
//   });
...
//       },
//     });
//     await expectCodeThrowsAsync(() => clientsEntity({ params }), 'passwordError');
//   });
...
//       },
//     });
//     await expectCodeThrowsAsync(() => clientsEntity({ params }), 'companyError');
//   });
...
//       },
//     });
//     await expectCodeThrowsAsync(() => clientsEntity({ params }), 'countryCodeError');
//   });
